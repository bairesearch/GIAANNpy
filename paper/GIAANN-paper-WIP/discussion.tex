...
While inherently more robust to hallucination, the prediction performance of GIAANN is measured to be lower than that of a Transformer. GIAANN proto v2 produced an OSCAR-2201 subword token top-1 test accuracy $\approx 0.23$ after 100,000 sequences comprising 38M tokens (\Cref{tab:protov2m-oscar-test-top1-accuracy-models-inferenceLeakyIntegrateAndFire}), compared to a 6-layer 512-token context RoBERTa Causal Transformer Language Model \citep{liu2019roberta} accuracy of $\approx 0.34$ after 100,000 sequences comprising 33M tokens \citep{bairesearch2022TSBNLP}.
