...
While inherently more robust to hallucination, the prediction performance of GIAANN is measured to be lower than that of a Transformer. GIAANN proto v2 produced an OSCAR-2201 subword token top-1 test accuracy $\approx 0.27$ after 100,000 sequences comprising 38M tokens (\Cref{tab:protov2o-oscar-test-top1-accuracy-models-inferenceLeakyIntegrateAndFire-predictionEnsureConnectedToPreviousPredictionTrue}), compared to a 6-layer 512-token context RoBERTa Causal Transformer Language Model \citep{liu2019roberta} accuracy of $\approx 0.32$ after 100,000 sequences comprising 33M tokens \citep{bairesearch2022TSBNLP}. With direct connectivity enforcement disabled during inference (risks hallucinated transitions), this increases to  $\approx 0.30$ (\Cref{tab:protov2o-oscar-test-top1-accuracy-models-inferenceLeakyIntegrateAndFire-predictionEnsureConnectedToPreviousPredictionFalse}).
