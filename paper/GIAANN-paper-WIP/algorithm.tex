...
\begin{center}
\includesvg[width=\linewidth]{demo/GIAANNSANIengine.svg}
\par\smallskip
\refstepcounter{figure}\label{fig:GIAANNSANIengine}
\textbf{Figure~\thefigure:} Illustration of a SANI neuron within GIAANN.
\end{center}
