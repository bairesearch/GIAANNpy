...
\subsection{GIAANN Proto Specification v1}\label{subsec:appendix-giaann-proto-spec}
...
\subsection{GIAANN Proto Specification v2}\label{subsec:appendix-giaann-proto-spec-v2}

\noindent\textbf{File:} \texttt{dev/GIAANNproto2.nlc}
