...
The performance measurements were taken with GIAANN Proto 1l/1m, after splitting the souce feature connections tensors per source feature.
...
Database global feature neuron sparse tensors are by default stored in RAM during training (i.e. \texttt{storeDatabaseGlobalFeatureNeuronsInRam=True}: global feature neuron tensors).  Else if \texttt{storeDatabaseFeatureConnectionsAndColumnFeatureNeuronsInRam=True}: the column feature neurons are stored independently in RAM, or if \texttt{storeDatabaseFeatureConnectionsAndColumnFeatureNeuronsInRam=False}: the filesystem database column feature neurons are read/written into/from RAM on a per sequence basis. Enabling global feature neuron tensors is mandatory during inference (i.e. \texttt{storeDatabaseGlobalFeatureNeuronsInRam=True}). 

If \texttt{storeDatabaseGlobalFeatureNeuronsInRam=False}, feature neuron sparse tensors are stored independently for each column. If the train phase was conducted with \texttt{storeDatabaseGlobalFeatureNeuronsInRam=False}, either \texttt{lowMemGenerateGlobalFeatureNeuronsTensor=True} must also be enabled (to generate the global feature neurons on exit), or the subsequent inference phase must be performed with \texttt{highMemGenerateGlobalFeatureNeuronsTensor=True} (to generate the global feature neurons on startup). 
...
Database feature connections sparse tensors are by default all stored in RAM during training (\texttt{storeDatabaseFeatureConnectionsAndColumnFeatureNeuronsInRam=True}). Else the filesystem database feature connections are read/written into/from RAM on a per sequence basis (RAM memory discarded).
...
\Cref{tab:oscar-performance-storeDatabaseInRamTrue} contains OSCAR-2201 performance measurements for different execution phases (train, eval training-set, eval test-set) and training sizes, with store database feature neurons and connections actively in RAM (\texttt{storeDatabaseGlobalFeatureNeuronsInRam=True}, \texttt{storeDatabaseFeatureConnectionsAndColumnFeatureNeuronsInRam=True}). It also contains time measurements separated for the final write (train phase) or initial read (inference phase) of the entire database from/to CPU RAM (``t w/r''), where ``t tot = t proc + t w/r''. GPU RAM measurements were calculated as peak memory allocated across execution, and CPU RAM measurements were taken by averaging process memory usage during execution of the highest GPU RAM function under default settings (\texttt{updateObservedColumnsEfficient()}). CPU RAM measurements are less sensitive to function execution timing as they are typically dominated by persistent database memory.
...
Option \texttt{useGPUsparseStrict} was disabled during the generation of \Cref{tab:oscar-performance-trainSparseConnectionsTensor}, \Cref{tab:oscar-performance-trainGlobalOrColumnFeatureNeuronTensors}, \Cref{tab:oscar-performance-trainSparseConnectionsNeuronsTensor-storeDatabaseFeatureNeuronsInRamFalse}, \Cref{tab:oscar-performance-trainSparseConnectionsNeuronsTensor-storeDatabaseFeatureNeuronsInRamFalse-storeDatabase} results. Within these specific environments (\texttt{executionMode=="train"} and \texttt{arrayIndexPropertiesEfficient}), setting \texttt{useGPUsparseStrict=False} could slightly increase peak GPU RAM in \texttt{updateObservedColumnsEfficient()}. When \texttt{useGPUsparse=False}, and \texttt{trainSparseConnectionsTensor=False} or \texttt{trainSparseNeuronsTensor=False}, large mostly-zero dense sequence tensors are converted to sparse tensors using the GPU (and only then moved to GPU). With \texttt{useGPUsparseStrict=True} however, the conversion to sparse device occurs before the conversion of the dense tensors to sparse type.
...
\midrule
8 & 3 & 5 & 5,000       & dense & 00:01:05 & 00:00:54 & 00:00:11 & 0.9GB & 1.9GB \\
8 & 3 & 5 & 200,000     & dense & 01:30:38 & 01:26:02 & 00:04:36 & 1.9GB & 6.9GB \\
8 & 3 & 5 & 5,000       & sparse con & 00:02:03 & 00:01:47 & 00:00:16 & 0.1GB & 1.9GB \\
8 & 3 & 5 & 200,000     & sparse con & 01:52:59 & 01:48:03 & 00:04:56 & 1.8GB & 4.8GB \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
8 & 3 & 5 & 5,000       & global & 00:01:05 & 00:00:54 & 00:00:11 & 0.9GB & 1.9GB \\
8 & 3 & 5 & 200,000     & global & 01:30:38 & 01:26:02 & 00:04:36 & 1.9GB & 6.9GB \\
8 & 3 & 5 & 5,000       & column & 00:02:16 & 00:01:54 & 00:00:21 & 0.9GB & 1.9GB \\
8 & 3 & 5 & 200,000     & column & 00:52:38 & 00:48:53 & 00:03:45 & 1.4GB & 5.0GB \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
8 & 3 & 5 & 5,000       & dense & GPU & 00:02:16 & 00:01:54 & 00:00:21 & 0.9GB & 1.9GB \\
8 & 3 & 5 & 200,000     & dense & GPU & 00:52:38 & 00:48:53 & 00:03:45 & 1.4GB & 5.0GB \\
8 & 3 & 5 & 5,000       & sparse & GPU & 00:01:33 & 00:01:23 & 00:00:09 & 0.02GB & 1.8GB \\
8 & 3 & 5 & 200,000     & sparse & GPU & 00:58:28 & 00:54:55 & 00:03:33 & 0.5GB & 4.9GB \\
8 & 3 & 5 & 5,000       & sparse & CPU & 00:01:16 & 00:01:07 & 00:00:08 & 0.0GB & 1.7GB \\
8 & 3 & 5 & 200,000     & sparse & CPU & 01:01:01 & 00:57:33 & 00:03:27 & 0.0GB & 4.9GB \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
8 & 3 & 5 & 5,000       & RAM & 00:01:16 & 00:01:07 & 00:00:08 & 0.0GB & 1.7GB \\
8 & 3 & 5 & 200,000     & RAM & 01:01:01 & 00:57:33 & 00:03:27 & 0.0GB & 4.9GB \\
8 & 3 & 5 & 5,000       & filesys & 00:02:07 & 00:02:07 & 00:00:00 & 0.0GB & 1.6GB \\
8 & 3 & 5 & 200,000     & filesys & 01:34:21 & 01:34:21 & 00:00:00 & 0.0GB & 1.8GB \\
\bottomrule
\end{tabular}
\end{table}
