...
\caption{OSCAR-2201 Top-1 test-set accuracy for different inference connection strength types (bool or float), training sizes, and inference activations, with segment timing none (t-1 none), and targets fed as input.}
