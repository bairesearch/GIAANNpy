...
\paragraph{Hardware.}
ASUS B760 Intel Chipset, ASUS GeForce RTX 5070 (12GB GDDR7), NVIDIA Driver 580.126.09, CUDA 12.8. Intel i7 14700F. 64GB DDR4. Samsung 990 Pro PCIe 4.0 NVMe M.2 SSD (1TB).
...
16 & 5 & 9 & 5,000   & 1.000 & 1.000 & 28.9M & 0.2GB \\
...
To improve evaluation efficency (speed), \texttt{spacyPipelineOptimisations=True} has been set in \Cref{tab:oscar-test-top1-accuracy-spacyPipelineOptimisations}, \Cref{tab:oscar-test-top1-accuracy-spacyPipelineOptimisations-trainsize}, \Cref{tab:oscar-test-top1-accuracy-useBenchmarkDefaultsFalse-multisentencePredictions}, \Cref{tab:oscar-test-top1-accuracy-spacyPipelineOptimisations-inferenceActivations}, \Cref{tab:oscar-test-top1-accuracy-spacyPipelineOptimisations-inferenceActivations-multisentencePredictionsInference}, and \Cref{tab:oscar-test-top1-accuracy-spacyPipelineOptimisations-multipleDendriticBranches} as these optimisations have been confirmed to not significantly affect reported test-set accuracy. With 5000 trained sequences for example, the test-set accuracy difference with \texttt{spacyPipelineOptimisations=True} is exactly -0.002, for seed lengths 8, 12, and 16.
