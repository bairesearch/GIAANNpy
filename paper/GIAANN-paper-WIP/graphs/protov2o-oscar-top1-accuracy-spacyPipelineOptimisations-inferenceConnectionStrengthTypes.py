...
y2 = np.array([1.0, 0.994, 0.984, 0.971])
...
plt.savefig("protov2o-oscar-top1-accuracy-spacyPipelineOptimisations-inferenceConnectionStrengthTypes.pdf", format="pdf", bbox_inches="tight")
plt.show()
