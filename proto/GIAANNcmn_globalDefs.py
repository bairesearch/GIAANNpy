...
if(useInference):
	...
	if(useTrainDuringInference):
		useInferenceDuringTrainAdjustSynapseStrength = False	#default: False
		if(useInferenceDuringTrainAdjustSynapseStrength):
			...
			if(executionMode=="trainDuringInference"):
				...
				if(inferenceDuringTrainAdjustSynapseStrength):
					...
					inferenceDuringTrainMinimumIndex = 0
					inferenceDuringTrainFirstTensorElementIndex = 0
					inferenceDuringTrainGatherIndexTensorRank = 1
					inferenceDuringTrainTargetConnectionIndexBranch = 0
					inferenceDuringTrainTargetConnectionIndexSegment = 1
